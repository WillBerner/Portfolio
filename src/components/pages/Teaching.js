...
export default function Teaching() {
    ...
    return (
        <div className="container my-5">
            ...
            <div className="row justify-content-center mb-5">
                <div className="row mx-3">
                    <h6 className="text-center">
                        During my undergraduate studies at UNC-Chapel Hill, I worked in the Computer Science Department as an Undergraduate Teaching Assistant for three different classes across six semesters, including one summer semester.
                    </h6>
                </div>
            </div>
            ...
            <div className="row mb-4 justify-content-center">
                <div className="col-12">
                    <img src="./assets/images/OpenHouse.jpg" className="rounded img-responsive center-block d-block mx-auto" alt="Me explaining how Stereolithographic 3D printers work" title="Me explaining how Stereolithographic 3D printers work" style={OpenHouseStyle} />
