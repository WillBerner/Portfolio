    ...
    return (
        <div className="container mt-5">
            ...
            <div className="row mx-3">
                <h6 className="my-5 text-center">My name is Will and I'm a recent graduate of UNC-Chapel Hill's Department of Computer Science.</h6>
                <p className="mb-4">
                ...
                <p className="mb-4">
                    I'm currently taking a Web Development Bootcamp to continue to learn new technologies and build on my skill set while I apply to full-time roles. I love any sort of programming from OOP to Functional, but enjoy creating Javascript web projects the most.
                </p>
